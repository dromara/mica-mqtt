 ...
 * @since 2.6.0
 */
public class MqttClusterBroker2 {
	...
	public static void main(String[] args) {
		...
		int mqttPort = args.length > 0 ? Integer.parseInt(args[0]) : 1884;
		int clusterPort = args.length > 1 ? Integer.parseInt(args[1]) : 9002;
		String suffix = args.length > 2 ? args[2] : "node-b";
