 ...
 * @since 2.6.0
 */
public class MqttClusterBroker4 {

	public static void main(String[] args) {
		int mqttPort = args.length > 0 ? Integer.parseInt(args[0]) : 1886;
		int clusterPort = args.length > 1 ? Integer.parseInt(args[1]) : 9004;
		String suffix = args.length > 2 ? args[2] : "node-d";
