...
public final class MqttHttpRoutes {
	...
	private static final Map<RouteInfo, HttpRequestHandler> ROUTS = new HashMap<>();
	 ...
	 * @param method  请求方法
	 * @param path    路径
	 * @param handler HttpRequestHandler
	 */
	public static void register(Method method, String path, HttpRequestHandler handler) {
	 ...
	 * @return HttpHandler
	 */
	public static HttpRequestHandler getHandler(RequestLine requestLine) {
	 ...
	 * @return 路由信息
	 */
	public static Map<RouteInfo, HttpRequestHandler> getRouts() {
